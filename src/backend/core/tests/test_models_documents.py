...
def test_models_documents_manager_time_filter_oldest_updated_at():
    ...
    document_at_boundary = create_document_with_updated_at(updated_at=lower_time_bound)
    document_recent = create_document_with_updated_at(
        updated_at=lower_time_bound + timedelta(days=15)
    )

    queryset = models.Document.objects.time_filter(lower_time_bound=lower_time_bound)
...
def test_models_documents_manager_time_filter_newest_updated_at():
    ...
    document_at_boundary = create_document_with_updated_at(updated_at=upper_time_bound)
    document_too_recent = create_document_with_updated_at(
        updated_at=upper_time_bound + timedelta(days=15)
    )

    queryset = models.Document.objects.time_filter(upper_time_bound=upper_time_bound)
...
def test_models_documents_manager_time_filter_deleted_at():
...
def test_models_documents_manager_time_filter_ancestors_deleted_at():
